<?php
    ...
    $topic = "Traveling (part 6 of 8)";
    $questions = [
        ["I tend to take routes that avoid areas that are not predominantly white due to safety concerns.", [6, 5, 4, 3, 2, 1, 0]], 
        ["When asking for help in an unfamiliar place, I tend to go to people that appear to have a similar background to mine.", [6, 5, 4, 3, 2, 1, 0]]
    ];
?>
...
<html>
	<head>
		<meta charset="utf-8" />
		<title>Questions (part 6 of 8)</title>
