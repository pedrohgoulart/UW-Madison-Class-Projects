<?php
    ...
    $topic = "Food (part 2 of 8)";
    $questions = [
        ["When in a Mexican restaurant, I expect that the workers know how to speak Spanish.", [6, 5, 4, 3, 2, 1, 0]], 
        ["When in a German restaurant, I expect that the workers know how to speak German.", [6, 5, 4, 3, 2, 1, 0]],
	["I find restaurants from Chinese neighborhoods to be less sanitary.", [6, 5, 4, 3, 2, 1, 0]]
    ];
...
<html>
	<head>
		<meta charset="utf-8" />
		<title>Questions (part 2 of 8)</title>
