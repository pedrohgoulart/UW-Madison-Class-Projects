<?php
    ...
    $topic = "Transportation (part 1 of 8)";
    $questions = [
        ["When taking a form of transportation (bus, plane, etc.), you get surprised when you see a person of color within the business class or the VIP lounge.", [6, 5, 4, 3, 2, 1, 0]], 
        ["People of color driving an older vehicle tend to look suspicious.", [6, 5, 4, 3, 2, 1, 0]]
    ];
?>
...
<html>
	<head>
		<meta charset="utf-8" />
		<title>Questions (part 1 of 8)</title>
